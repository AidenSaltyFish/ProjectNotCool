...
# Task Discription
Idealy we shall plot hotzones of early smoking, in terms of any individul student's own risk behaviors and the environment based on his school (the school's supportive score and the distance to retailers), since youth smoking is an issue calling on efforts from multiple parties. The cautionary results would suggest special measures for the hotzones' authorities, such as goverment's education branches, tobacco branches and each community's own administrators to regulate the smoking behaviors among teenagers. In a more broad way, the results would be useful for any city management plan in the goal of youth tobacco control, and furthermore the city's sustainability.
